 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`sexcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`sexcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'sexcore-' + name : 'sexcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/sexcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external sexcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:sexcore-lib -o sexcore-lib.js';
    }
